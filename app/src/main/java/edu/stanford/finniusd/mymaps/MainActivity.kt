...
import edu.stanford.finniusd.mymaps.models.Place
...
private const val TAG = "onActivityResult"
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //set layout manager and the recycler view.
        rvMaps.layoutManager = LinearLayoutManager(this)
        //set adapter on the recycler view
        mapAdapter = MapsAdapter(this, userMaps, object: MapsAdapter.OnClickListener {
            override fun onItemClick(position: Int) {
              Log.i(TAG, "onItemClick $position")
                //when the user clicks on an option, we want to navigate to a different page. Android manages different pages using Intents, these take the user somewhere.
    ...
    private fun showAlertDialog() {
        ...
        dialog.getButton(DialogInterface.BUTTON_POSITIVE).setOnClickListener {
            ...
            //Navigate to the create map activity
